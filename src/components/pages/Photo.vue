        ...
        <el-container class="containers">
            ...
            <el-container>
                ...
                <el-aside class="delete-info-container">
                    <h4 style="color:cyan;padding:5px;background:#111;">类型提示：{{clothesTypes}}</h4>
                    <h3>删除量统计</h3>
                    <el-collapse>
...
export default {
  ...
  computed: {
    'clothesTypes': function () {
      if (this.pictureInfo.clothesTypes !== undefined) {
        return this.pictureInfo.clothesTypes.join(' , ')
      } else {
        return []
      }
    }
